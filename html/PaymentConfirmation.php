		...
		<style>
			...
			*{
			...
			body{
				...
				background: linear-gradient(100deg,#f98eed ,#8e44ad);
			}
			.box{
				height:380px;
				width:400px;
			...
			.btn{
				...
				margin-top:18px;
				padding:10px;
				background: linear-gradient(120deg,#f98eed ,#8e44ad);
				font-size:18px;
				border:none;
				cursor:pointer;
			}
	...
	<body>
		<div class="box">
			<div>
				...
				<button type="button" class="btn"><a href="../html/Home.php" style = 'color: white; text-decoration: none;'>Home</a></button>
			</div>
		</div>
	</body>
</html>