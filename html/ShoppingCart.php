...
<header id="home" class="welcome-hero">
    ...
    <section class="sec-product-detail bg0">
        <div class="container">
            <div class=" p-l-10 p-r-15 p-t-120 ">
                <a href="../html/Home.php" class="cl8 hov-cl1 ">
                    Home
                    <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
                </a>

                <a href="../html/ShoppingCart.php" class="cl8 hov-cl1 ">
                    ShoppingCart
                    <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
                </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                        ...
                        <div>
                            <input type="submit" value="Update Cart" name="UpdateCart" style=" width: 100%; height: 50px"   class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" />
                        </div>
        </form>
    </form>
    ...
    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
        <div class="bor10 p-lr-30 p-t-20 p-b-20 m-l-80 m-r-20 m-lr-0-xl p-lr-15-sm">
            ...
            <input type="submit"  name="GoToPayment"  value="Proceed to Checkout" class="btn flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer"/>
            </form>
        </div>
    </div>
    </div>
                    ...
                    <div class="hm-footer-widget">
                        ...
                        <div class="hm-foot-menu">
                            <ul>
                                ...
                                <li><a href="Lighting.php">Lighting</a></li><!--/li-->
                                <li><a href="Appliances.php">Appliances</a></li><!--/li-->
                                <li><a href="Kitchen.php">Kitchen </a></li><!--/li-->
