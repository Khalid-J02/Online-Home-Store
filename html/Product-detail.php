                ...
                <div class="container">
                    ...
                    <div class="attr-nav">
                        <ul>
                            ...
                            <li class="dropdown">
                                <a href="../html/ShoppingCart.php" class="dropdown-toggle" data-toggle="dropdown" >
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        <h4 class="mtext-105 cl2 js-name-detail"> <?php  echo $row['product_name']; ?></h4>
                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            ...
                            <button type="submit" name="AddToCart" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 m-t-20">
                                Add to cart
                            </button>
