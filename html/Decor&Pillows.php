            ...
            <div class = "main-wrapper">
                <div class = "container">
                    <div class = "main-title">
                        <h1>Décor & Pillows Shop List</h1>
                    </div>

                    <div class = "item-list">
                        <?php
                        $query = "SELECT * FROM product WHERE dep_id='5'";
                        $query_run = mysqli_query($connection, $query);
                    ...
                    <div class="hm-footer-widget">
                        ...
                        <div class="hm-foot-menu">
                            <ul>
                                ...
                                <li><a href="../html/Bedding%20&%20Bath.html">Bedding & Bath</a></li><!--/li-->
                                <li><a href="../html/Décor%20&%20Pillows.html">Décor & Pillows</a></li><!--/li-->
                    ...
                    <div class="hm-footer-widget">
                        ...
                        <div class="hm-foot-menu">
                            <ul>
                                ...
                                <li><a href="ShoppingCart.php">my cart</a></li><!--/li-->
